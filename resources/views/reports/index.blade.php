            ...
            <div>
                ...
                <div x-show="showBreakdown" x-cloak class="mt-2 space-y-1">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="flex-1 min-w-0" style="height:4px; border-radius:9999px; background-color:#e2e8f0">
                            <div style="height:4px; border-radius:9999px; background-color:rgba(99,102,241,0.7); width:{{ max($upct, $row->cnt > 0 ? 4 : 0) }}%"></div>
                        </div>
