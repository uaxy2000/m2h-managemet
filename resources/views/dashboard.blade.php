...
$phases = [
    [
        ...
        'items' => [
            ...
            ['label' => 'Kanban sort toggle — Application Date vs Stage Entry Date; both dates shown on card (Rec./Stg.)', 'complete' => true],
    ...
    [
        ...
        'items' => [
            ...
            ['label' => 'WhatsApp — Business Calling API (browser answer via WebRTC) [blocked: display name approval + Meta review]', 'complete' => false],
            ['label' => 'Facebook/Instagram DMs → CRM lead/activity [blocked: Meta App Review for messaging permissions]', 'complete' => false],
            ['label' => 'Facebook/Instagram post comments → Social Inbox [blocked: Meta App Review]', 'complete' => false],
    ...
    [
        ...
        'items' => [
            ...
            ['label' => 'Performance tracking — per-user registration stats, conversion, avg days (from assignment), monthly breakdown + registered lead timeline modal', 'complete' => true],
