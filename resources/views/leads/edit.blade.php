...
@section('title', 'Edit — ' . $lead->fullName())
...
<div class="max-w-2xl"
     x-data="{
         ...
         pipelineId: '{{ old('pipeline_id', $lead->pipeline_id) }}',
         stageId:    '{{ old('stage_id',    $lead->stage_id) }}',
         subStageId: '{{ old('sub_stage_id', $lead->sub_stage_id ?? '') }}',
         get stages() {
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <h2 class="text-sm font-semibold text-gray-700 mb-6">Edit Lead</h2>
        ...
        <form method="POST" action="{{ route('leads.update', $lead) }}">
            ...
            <div class="grid grid-cols-3 gap-4 mb-5">
                <div>
                    ...
                    <input type="text" name="country_of_origin" value="{{ old('country_of_origin', $lead->country_of_origin) }}"
                           class="block w-full rounded-lg border-gray-300 text-sm shadow-sm
                                  focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="language" value="{{ old('language', $lead->language) }}"
                           class="block w-full rounded-lg border-gray-300 text-sm shadow-sm
                                  focus:ring-indigo-500 focus:border-indigo-500">
                </div>
            </div>
