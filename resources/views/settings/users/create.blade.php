...
<div class="max-w-lg">
    <h2 class="text-base font-semibold text-gray-800 mb-5">Yeni Kullanıcı</h2>
    ...
    <form method="POST" action="{{ route('settings.users.store') }}" class="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
        @csrf
