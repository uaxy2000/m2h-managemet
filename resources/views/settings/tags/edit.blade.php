...
<div class="bg-white rounded-xl border border-gray-200 p-6 max-w-sm"
     x-data="{ color: '{{ old('color', $tag->color) }}' }">

    <h2 class="text-sm font-semibold text-gray-700 mb-6">Edit Tag</h2>
    ...
    <form method="POST" action="{{ route('settings.tags.update', $tag) }}">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="name" value="{{ old('name', $tag->name) }}" required autofocus
