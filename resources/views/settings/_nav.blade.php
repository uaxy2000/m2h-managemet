<div class="flex gap-0 mb-6 border-b border-gray-200 -mt-1 overflow-x-auto">
    ...
    <a href="{{ route('settings.meeting-rooms.index') }}"
       class="flex-shrink-0 px-4 py-2.5 text-sm font-medium border-b-2 transition-colors
              {{ request()->is('settings/meeting-rooms*') ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
        Meeting Rooms
    </a>
</div>
