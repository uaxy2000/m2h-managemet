...
<div class="p-6 max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('finance.categories.index') }}" class="px-3 py-1.5 text-sm bg-gray-100 text-gray-600 rounded-lg border border-gray-200 hover:bg-gray-200 transition-colors font-medium">Categories</a>
